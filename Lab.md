...
3. มีบรรทัดใดบ้าง ที่มีข้อความผิดพลาด 
   ...
   ![3 1](https://user-images.githubusercontent.com/89035964/167894803-39ff3d06-5c31-4455-9e66-05a9d29fd249.png)
...
```
![8 2 1](https://user-images.githubusercontent.com/89035964/167904686-4e73b8a8-5fe1-4900-9c94-1a894a1d0535.png)
...
```
![8 2 2](https://user-images.githubusercontent.com/89035964/167904699-ff519682-bec1-4458-96da-b3cbe4f9ba52.png)
...
```
![8 2 3](https://user-images.githubusercontent.com/89035964/167904709-d064b829-2212-4953-a648-34d917c22776.png)
...
```
![8 2 4](https://user-images.githubusercontent.com/89035964/167904731-93c458e1-5ebb-47e8-87be-af9fb1d0c2ff.png)
...
```
![8 2 5](https://user-images.githubusercontent.com/89035964/167904741-da9333de-615d-487c-821f-d473a9977bda.png)
...
```
![8 2 6](https://user-images.githubusercontent.com/89035964/167904752-44947ee1-3322-4d5a-a54c-2d29dace3dcb.png)
...
```
![8 2 7](https://user-images.githubusercontent.com/89035964/167904777-88e86002-a638-4bec-b526-5af1fde04616.png)
...
![8 3 1](https://user-images.githubusercontent.com/89035964/167905213-458ba99a-4a61-4c25-be0c-888b3734abba.png)

2. บรรทัดไหนของโปรแกรมที่มี error บ้าง เพราะอะไร
```
   บรรทัด 22 เพราะไม่ได้ประกาศตัวแปรเป็น static public int และ static public double
   บรรทัด 24 เพราะไม่ได้ประกาศตัวแปรเป็น static public int และ static public double
   บรรทัด 27 เพราะไม่สามารถแสดงค่าตัวแปร number.numberInt2 และ number.numberDouble2
   บรรทัด 29 เพราะไม่สามารถแสดงค่าตัวแปร number.numberInt2 และ number.numberDouble2
```
...
```
![8 3 3](https://user-images.githubusercontent.com/89035964/167906711-0669e050-59ac-45bc-9b4b-e8312dab183f.png)
